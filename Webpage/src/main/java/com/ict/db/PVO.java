...
private int p_idx, p_price, p_saleprice ;
// 추가 (파라미터이름)
...
// 세일품목과 아닌 품목을 나중에는 나누자
setTotalPrice(quant*p_saleprice);
}

public PVO() {}

public PVO(String category, String p_num, String p_name, String p_company, String p_image_s, String p_image_l,
String p_content, String p_date, int p_idx, int p_price, int p_saleprice) {
super();
